            ...
            onPressed: () async {
              ...
              try {
                ...
                for (final data in syncedTodoData) {
                  ...
                  bool shoppingItemExists =
                      dbHelper.checkIfShoppingItemExists(fireStoreTodo) is bool;
                  bool todoItemListExists =
                      dbHelper.checkIfTodoItemExists(fireStoreTodo) is bool;
